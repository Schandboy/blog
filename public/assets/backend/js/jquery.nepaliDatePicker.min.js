...
!function ($) {
    var calendarData = {
        ...
        minBsYear: 1970,
        maxBsYear: 2100,
        minAdDateEqBsDate: {ad: {year: 1913, month: 3, date: 13}, bs: {year: 1970, month: 1, date: 1}}
    }, validationFunctions = {
    ...
    $.extend(calendarFunctions, {
        getNepaliNumber: function (number) {
            ...
            var prefixNum = Math.floor(number / 10), suffixNum = number % 10;
            ...
            if (validationFunctions.validateRequiredParameters({
                ...
                bsMonth: bsMonth,
                bsDate: bsDate
            }), validationFunctions.validateBsYear(bsYear), validationFunctions.validateBsMonth(bsMonth), validationFunctions.validateBsDate(bsDate), null === dateFormatPattern) dateFormatPattern = "%D, %M %d, %y"; else if ("string" != typeof dateFormatPattern) throw new TypeError("Invalid parameter dateFormatPattern value");
            ...
            validationFunctions.validateRequiredParameters({
                bsMonth: bsMonth,
                yearDiff: yearDiff
            }), validationFunctions.validateBsMonth(bsMonth), validationFunctions.validatePositiveNumber({yearDiff: yearDiff});
            var yearCount = 0, monthDaysFromMinBsYear = 0;
            if (0 === yearDiff) return 0;
            for (var bsMonthData = calendarData.extractedBsMonthData[bsMonth - 1], i = 0; i < bsMonthData.length; i++) if (0 !== bsMonthData[i]) {
            ...
            for (var yearCount = 0, totalYears = bsYear + 1 - calendarData.minBsYear, bsMonthData = calendarData.extractedBsMonthData[bsMonth - 1], i = 0; i < bsMonthData.length; i++) if (0 !== bsMonthData[i]) {
                var bsMonthUpperDaysIndex = i % 2;
            ...
            var bsYear = adYear + 57, bsMonth = (adMonth + 9) % 12;
            bsMonth = 0 === bsMonth ? 12 : bsMonth;
            var bsDate = 1;
            if (adMonth < 4) bsYear -= 1; else if (4 === adMonth) {
            ...
            return {bsYear: bsYear, bsMonth: bsMonth, bsDate: bsDate}
            ...
            var eqAdDate = calendarFunctions.getAdDateByBsDate(bsYear, bsMonth, bsDate),
                weekDay = eqAdDate.getDay() + 1, formattedDate = dateFormatPattern;
            ...
            for (var diffTextNum = 0, extractedFormattedBsDate = {
                ...
                bsDate: null,
                bsDay: null
            }, i = 0; i < dateFormat.length; i++) if ("%" === dateFormat.charAt(i)) {
                var valueOf = dateFormat.substring(i, i + 2), endChar = dateFormat.charAt(i + 2),
        ...
        var datePickerPlugin = {
            options: $.extend({
                ...
                $element.click(function () {
                    ...
                    if ($(this).find(".drop-down-content").is(":visible")) $(this).find(".drop-down-content").hide(); else {
                    ...
                    if (!$(this).hasClass("disable")) {
                        var datePickerData = $nepaliDatePicker.data(), bsYear = datePickerData.bsYear,
                            bsMonth = datePickerData.bsMonth, preDate = datePickerData.bsDate,
                ...
                var datePickerData = $nepaliDatePicker.data(), $monthSpan = $('<div class="current-month-txt">');
                $monthSpan.text(calendarData.bsMonths[datePickerData.bsMonth - 1]), $monthSpan.append('<i class="icon icon-drop-down">');
                for (var data = [], i = 0; i < 12; i++) data.push({label: calendarData.bsMonths[i], value: i + 1});
                ...
                var datePickerData = $nepaliDatePicker.data(), $yearSpan = $('<div class="current-year-txt">');
                ...
                var $dropDown = $('<div class="drop-down-content" data-value="' + activeValue + '">'),
                    $dropDownWrapper = $('<div class="option-wrapper">'), $ul = $("<ul>");
                ...
                var currentDate = new Date,
                    ...
                    bsYear = currentBsDate.bsYear, bsMonth = currentBsDate.bsMonth, bsDate = currentBsDate.bsDate;
                datePickerPlugin.setCalendarDate($nepaliDatePicker, bsYear, bsMonth, bsDate), datePickerPlugin.renderMonthCalendar($nepaliDatePicker)
