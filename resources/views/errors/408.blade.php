...
<div class="wrapper wrapper-full-page">
    <div class="page-header error-page header-filter" style="background-image: url({{asset('assets/backend/img/bg27.jpg')}})">
        <div class="content-center">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="title">408</h1>
                    <h1><b>Request Timeout</b></h1>
